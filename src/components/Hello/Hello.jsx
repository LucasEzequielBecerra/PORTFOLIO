...
const Hello = ( ) => {
  return (
    ...
    <Button  sx={{ backgroundColor:'#0c4489', color:'#e4edf1', ":hover":{scale:'1.1',  backgroundColor:'#0c4489'}, fontSize:'1.3rem', transition:'0.3s'}}  > <a href="Professional-Curriculum-Front-End-Dev.pdf" download='LucasRamos-Resume.pdf'>Download cv</a></Button>
    ...
    <ul className='social-buttons-list'>
        ...
        <li className='item-social'>
          <a target='_blank' href="https://mail.google.com/mail/u/0/#inbox?compose=DmwnWslzCgFhbwKlJKnBgNcmMXRXNkVcmljMQMwBBwwLKmzKNDVSSmPmlBWCmLFxfDlVGvzcKGwV" rel="noreferrer">
        ...
        <li className='item-social'>
          <a target='_blank' href="https://mail.google.com/mail/u/0/#inbox?compose=new" rel="noreferrer">
